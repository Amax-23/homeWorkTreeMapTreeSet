...
public class Main {
    public static void main(String[] args) {
        ...
        Person p1 = new Person("Irina", "Belkina Strelkina Vkosmosletayushaya", 21);
        Person p2 = new Person("Anatoliy", "Velichestvenniy", 19);
        Person p3 = new Person("Aleksey", "Evtushenko Tavricheskiy Perviy i Posledniy", 18);
        Person p4 = new Person("Aleksey", "Pryamohodyashiy", 29);
        Person p5 = new Person("Ifstafiy", "Vechno Molodoy Vechno Pyaniy ", 12);
        Person p6 = new Person("Nikolas", "Novogodniy", 20);
        Person p7 = new Person("Djoan", "Kisly Borsh Esli Mnogo Limona Dobavit", 15);
        Person p8 = new Person("Donald", "Trump Corp Limited", 25);
        set.add(p1);
        set.add(p2);
        set.add(p3);
        set.add(p4);
    ...
    public static void comparePersonPrintLn(Person one, Person thue) {
        //в методе используем компаратор с передачей макс количества слов в фамилии
